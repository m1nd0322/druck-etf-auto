...
VALID_CFG = {
    ...
    "selection": {
        ...
        "regime_factor_map": {
            "enabled": True,
            "RISK_ON": {"overweight": ["MTUM"], "underweight": ["USMV"], "bonus": 0.2, "penalty": 0.1, "min_count": 1},
            "NEUTRAL": {"overweight": ["QUAL"], "underweight": [], "bonus": 0.1, "penalty": 0.0, "min_count": 1},
            "RISK_OFF": {"overweight": ["USMV"], "underweight": ["MTUM"], "bonus": 0.2, "penalty": 0.1, "min_count": 1},
        },
        "max_weight": 0.25,
    },
    "risk_cut": {
