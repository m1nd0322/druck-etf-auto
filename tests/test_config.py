...
VALID_CFG = {
    ...
    "selection": {
        "top_n_risk_on": 8,
        "top_n_risk_off": 4,
        "score_weights": {"momentum": 0.55, "trend": 0.25, "relative_strength": 0.10, "vol_penalty": 0.10, "dd_penalty": 0.10},
        ...
        "regime_factor_map": {
            "enabled": True,
            "RISK_ON": {"overweight": ["MTUM"], "underweight": ["USMV"], "bonus": 0.2, "penalty": 0.1, "min_count": 1, "relative_strength_gate": {"enabled": True, "min_relative_strength_6m": -0.01, "mode": "penalty", "penalty": 0.1}},
            "NEUTRAL": {"overweight": ["QUAL"], "underweight": [], "bonus": 0.1, "penalty": 0.0, "min_count": 1, "relative_strength_gate": {"enabled": True, "min_relative_strength_6m": -0.02, "mode": "penalty", "penalty": 0.05}},
            "RISK_OFF": {"overweight": ["USMV"], "underweight": ["MTUM"], "bonus": 0.2, "penalty": 0.1, "min_count": 1, "relative_strength_gate": {"enabled": True, "min_relative_strength_6m": -0.02, "mode": "exclude", "penalty": 0.0}},
        },
        "max_weight": 0.25,
    },
    "risk_cut": {
